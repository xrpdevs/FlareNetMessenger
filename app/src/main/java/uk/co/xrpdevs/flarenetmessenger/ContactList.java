...
public class ContactList extends AppCompatActivity{
    ...
    public SimpleAdapter fillListView(final ArrayList<HashMap<String, String>> lines) {
        ...
        simpleAdapter = new SimpleAdapter(this, lines, R.layout.listitem_inbox, new String[]{"name", "numb", "type", "id"}, new int[]{R.id.inboxAddress, R.id.inboxContent, R.id.inboxType, R.id.inboxLastact}){
            @Override
